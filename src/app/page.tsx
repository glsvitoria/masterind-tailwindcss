      ...
      <div className="mt-6 flex flex-col">
        <div className="flex items-center justify-between border-b border-zinc-200 pb-5">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              className="rounded-lg border-zinc-300 px-4 py-2 text-sm font-semibold text-zinc-700 shadow-sm duration-300 hover:bg-zinc-50"
            >
              Cancel
            </button>
            <button
              type="submit"
              form="settings"
              className="rounded-lg bg-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-sm duration-300 hover:bg-violet-700"
            >
              Save
            </button>
          </div>
        ...
        >
          <div className="grid grid-cols-form gap-3 pb-5">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Input.Root>
                <Input.Control defaultValue="Vitória" />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 py-5">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="guivitoria2010@hotmail.com"
              />
            </Input.Root>
          </div>
